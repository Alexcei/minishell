...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/26 12:29:05 by bpole             #+#    #+#             */
/*   Updated: 2019/11/26 12:30:18 by bpole            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static size_t	ft_word_count(char const *str, char c1, char c2)
{
	size_t		tr;
	size_t		res;
